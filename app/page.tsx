      ...
      <div className="font-[poppins] text-[#0d1b2a] bg-[#e0e1dd]">
        ...
        <main id="about" className="flex justify-center p-20 z-20 relative mt-[150px]">
          <div className="w-3/5">
            ...
            <br></br>
            <p>Of course, it went off from there. I now am smarter and have done many more projects, partnering with organizations and professional engineers. Here{"'"}s a little portfolio of my projects and a timeline of my maker life.</p>
            <br></br>
