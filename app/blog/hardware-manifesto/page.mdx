...
2. [What is Hardware and Why Does It Matter?](#what-is-hardware-and-why-does-it-matter)
3. [The Hardware Development Paradigm: Why It's Different](#the-hardware-development-paradigm-why-its-different)
4. [The Growing Hardware Crisis](#the-growing-hardware-crisis)
5. [The Growing Opportunity](#the-growing-opportunity)
6. [Solutions and Recommendations](#solutions-and-recommendations)
...
<MdxImage 
    src="/images/blog/hardware/figure2.png" 
    title="Figure 1: Percentage change in the number of bachelor’s and master’s degrees conferred in electrical, electronics, and communications engineering vs. all other bachelor’s and master’s degrees (2021)" 
    alt="desc" 
    width={500} 
    height={500} 
    author="Long, T."
    date="2023"
    description="Percentage change in the number of bachelor’s and master’s degrees conferred in electrical, electronics, and communications engineering vs. all other bachelor’s and master’s degrees (2021)"
    link="https://itif.org/publications/2023/04/24/short-circuited-electrical-engineering-degrees-in-the-united-states/"
    source="ITIF"
    workTitle="Short Circuited: Electrical Engineering Degrees in the United States"
/>
