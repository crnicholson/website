...
export default function SliderImage(props: { src: string, alt: string }) {
    return (
        <>
            <div className="z-10 relative flex flex-col justify-center items-center rounded-lg mb-10 mt-5 p-3 transform transition-transform duration-300 hover:scale-105 bg-[#041D27] hover:shadow-2xl group" style={{ width: '300px' }}>
