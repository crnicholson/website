            ...
            <div className="h-fit w-fit mt-4">
                <a href={props.link} target="_blank">
                    <div className="group flex flex-col gap-2 items-center">
                        <div className="relative mx-5 my-2 transform transition-transform duration-300  bg-[rgba(0,0,0,.1)] group-hover:shadow-2xl h-[225px] sm:h-[300px] w-fit rounded-lg">
                            <Image
                                src={"/" + props.src}
                                width={300}
                                height={300}
