    ...
    return (
        <>
            <a href={props.url} target="_blank">
                <div className="relative group rounded-lg m-5 transform transition-transform duration-300 hover:scale-105 bg-[rgba(0,0,0,.1)] hover:shadow-2xl h-auto sm:h-[300px] w-fit">
