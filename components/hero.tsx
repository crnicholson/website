    ...
    return (
        <>
            <div className="relative bg-[#e0e1dd]">
                <div id="slash" className="ml-[-600px] sm:ml-[-1000px] absolute z-0 h-[115vh] mt-[-20px] rounded-[800px] w-[95vw] bg-gradient-to-r from-purple-400 via-pink-500 to-yellow-500 rotate-3 filter blur-lg" style={{ background: 'linear-gradient(60deg, #ff9e00, #ff165d, #ff38ef, #3a1c71, #d76d77, #ffaf7b)' }}></div>
                <div className="relative z-10 h-screen flex flex-col px-10">
                    ...
                    <div className="h-[10%] flex flex-col justify-center items-center">
                        <a href="#about" className="italic font-light underline decoration-dotted hover:decoration-solid text-[#0d1b2a] outline-dotted p-5 rounded-3xl bg-[#e0e1dd] opacity-40">
                            Psst! There{"'"}s more.
                        </a>
                    </div>
                </div>
